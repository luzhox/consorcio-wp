<div class="banner-intercambio">
  <div class="container">
    <div class="banner-intercambio__content">
      ...
      <div class="banner-intercambio__content__text"><?php the_sub_field('text'); ?>  </div>
      <div class="banner-intercambio__content__button">
        ...
        if ($button) {
          ...
          echo '<a class="btn btn__primary" href="' . esc_url($link) . '" target="' . esc_attr($target) . '" title="' . esc_attr($title) . '">' . esc_html($button['title']) . '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
