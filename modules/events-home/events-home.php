<section class="events-home">
  <div class="container">
    <div class="events-home__title">
      ...
      <a href="<?php echo get_permalink( get_page_by_path( 'eventos' ) ); ?>" class="btn__primary">Ver todos los eventos</a>
    </div>
    </div>
    <div class="events-home__events">
						...
						<?php $family = new WP_Query($args);?>
							<?php while($family->have_posts()): $family->the_post();?>
                                ...
                                if (has_post_thumbnail($post->ID)) {
                                    ...
                                    // Usar una imagen de marcador de posición de placehold.co
                                    // Puedes ajustar el tamaño (ej. 300x200) y el texto como necesites
                                    $url = 'https://placehold.co/300x200?text=Evento';
                                }
                                ?>
        <div class="event" data-aos="fade-up" data-aos-offset="100">
          ...
          <div class="event__text">
            <h5><strong>Realizado el:</strong> <?php the_date()?></h5>
            <h4><?php the_title();?></h4>
            <a href="<?php the_permalink()?>" class="btn__primary">Conoce más <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
