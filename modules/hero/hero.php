            ...
            while (have_rows('sliderhero')) {
                ...
                <div class="hero-item">
                    ...
                    <div class="hero-item__content container">
                        ...
                        ?>
                            <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
