<div class="header-background" data-aos="fade-in">
  ...
  <div class="container">
    <div class="header-background__content">
      ...
      ?>
        <a class="btn__primary" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
