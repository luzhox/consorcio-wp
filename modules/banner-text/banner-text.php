<div class="banner-text">
  <div class="container">
    ...
    <div class="banner-text__content" data-aos="fade-up">
            <a class="fulllink" href="<?= esc_url($button['url']); ?>"></a>

      <?php the_sub_field('text'); ?>
      <?php if ($button = get_sub_field('link')): ?>
        <div class="banner-text__content__button">
          <a href="<?= esc_url($button['url']); ?>" class="btn btn__primary" target="<?= esc_attr($button['target']); ?>">
